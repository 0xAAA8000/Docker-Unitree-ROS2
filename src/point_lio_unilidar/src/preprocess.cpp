...
// void Preprocess::process(const livox_ros_driver::CustomMsg::ConstSharedPtr &msg, PointCloudXYZI::Ptr &pcl_out)
// {  
//   avia_handler(msg);
//   *pcl_out = pl_surf;
// }
...
// void Preprocess::avia_handler(const livox_ros_driver::CustomMsg::ConstSharedPtr &msg)
// {
//   pl_surf.clear();
//   pl_corn.clear();
//   pl_full.clear();
